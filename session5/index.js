...
// //     // console.log(j.locations[0])
// //     // console.log(j.jobSalary)
...
// let userInput = prompt("Enter your category").toLowerCase()
// for(let i = 0 ; i<products.length; i++){
//     if(userInput == products[i].category.toLowerCase()){
        
//         console.log(`Name: ${products[i].name} \nPrice: ${products[i].price}`)
//     }
// }

let arr = ['God','Lucifer','Buddha', 'Odin']
prompt(arr[0], arr[1])